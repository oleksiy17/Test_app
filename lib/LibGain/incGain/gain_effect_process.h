#ifndef __GAIN_EFFECT_PROCESS_H__
#define __GAIN_EFFECT_PROCESS_H__
 ...
 ******************************************************************************/
int32_t gain_effect_process_get_sizes(
    size_t*     states_bytes);
